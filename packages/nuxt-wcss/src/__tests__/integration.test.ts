...
import nuxtWcssModule, { WCSSNuxtOptions } from '../index';
...
describe('Nuxt Module Integration Tests', () => {
  ...
  describe('sample Nuxt project integration', () => {
    it('should define a Nuxt module with correct metadata', () => {
      ...
      expect(nuxtWcssModule.meta.name).toBe('wcss');
      expect(nuxtWcssModule.meta.configKey).toBe('wcss');
    });
    ...
    it('should configure webpack loader with correct options', () => {
      ...
      const wcssRule = mockConfigs[0].module.rules[0];
    ...
    it('should handle multiple webpack configs', () => {
      ...
      // Both configs should have WCSS rule
      expect(mockConfigs[0].module.rules).toHaveLength(1);
  ...
  describe('configuration options', () => {
    ...
    it('should support all options combined', () => {
      ...
      expect(wcssPlugin).toHaveBeenCalledWith(options);
    });
  ...
  describe('module exports', () => {
    it('should export WCSSNuxtOptions type', () => {
      const options: WCSSNuxtOptions = {
        minify: true,
        sourceMaps: true,
        treeShaking: false,
