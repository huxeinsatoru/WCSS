...
describe('WASM Integration Tests', () => {
  describe('compile() from JavaScript', () => {
    it('should compile valid Euis to CSS', async () => {
      const source = `
.button {
  padding: 1rem;
  background: #3b82f6;
...
`;
    ...
    it('should compile Euis with design tokens', async () => {
      const source = `
.button {
  padding: $spacing.md;
...
`;
    ...
    it('should return errors for invalid Euis', async () => {
      const source = `
.button {
...
`;
  ...
  describe('parse() function', () => {
    it('should parse valid Euis to AST', async () => {
      const source = `
.button {
  padding: 1rem;
}
...
`;
  ...
  describe('format() function', () => {
    it('should format Euis source', async () => {
...
`;
  ...
  describe('validate() function', () => {
    it('should validate Euis without full compilation', async () => {
      const source = `
.button {
  padding: 1rem;
}
