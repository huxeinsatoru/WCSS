...
describe('CLI Integration Tests', () => {
  ...
  beforeEach(() => {
    ...
    tempDir = fs.mkdtempSync(path.join(os.tmpdir(), 'euis-test-'));
  ...
  describe('build command', () => {
    it('should compile a single Euis file', async () => {
      const inputPath = path.join(tempDir, 'input.euis');
...
`,
    ...
    it('should compile multiple files with glob pattern', async () => {
      ...
      const file1 = path.join(tempDir, 'button.euis');
      const file2 = path.join(tempDir, 'card.euis');
    ...
    it('should handle compilation errors gracefully', async () => {
      const inputPath = path.join(tempDir, 'invalid.euis');
...
`,
  ...
  describe('format command', () => {
    it('should format Euis file without writing', async () => {
      const inputPath = path.join(tempDir, 'input.euis');
    ...
    it('should format and write Euis file', async () => {
      const inputPath = path.join(tempDir, 'input.euis');
...
`,
    ...
    it('should display helpful suggestions for common errors', async () => {
      const inputPath = path.join(tempDir, 'typo.euis');
