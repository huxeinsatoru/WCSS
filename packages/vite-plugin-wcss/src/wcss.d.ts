/**
 * TypeScript module declaration for .wcss file imports
 * 
 * This declaration provides type safety when importing .wcss files in TypeScript projects.
 * The vite-plugin-wcss transforms .wcss files into JavaScript modules that export:
...
declare module '*.wcss' {
   ...
   * This is the result of compiling the .wcss file to standard CSS.
   */
  const css: string;
