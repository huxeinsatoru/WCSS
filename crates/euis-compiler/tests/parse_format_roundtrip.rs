// Feature: euis-framework, Property 1: Parse-Format Round-Trip Preservation
// **Validates: Requirements 1.1, 13.1, 13.4**

use proptest::prelude::*;
use euis_compiler::ast::*;
use euis_compiler::formatter::format_stylesheet;
...
proptest! {
    ...
    /// For any valid Euis source code, parsing to an AST, formatting back
    ...
    fn prop_parse_format_roundtrip(stylesheet in stylesheet_strategy()) {
        ...
        prop_assert!(
            parse_result.is_ok(),
            "Formatted Euis should parse successfully. Errors: {:?}\nFormatted source:\n{}",
            parse_result.err(),
            formatted_source
        );
    ...
    /// Property: Format produces valid Euis
    /// For any AST, formatting should produce valid Euis that can be parsed.
    #[test]
    fn prop_format_produces_valid_euis(stylesheet in stylesheet_strategy()) {
        ...
        prop_assert!(
            parse_result.is_ok(),
            "Formatted Euis should be parseable. Errors: {:?}\nFormatted:\n{}",
            parse_result.err(),
            formatted
        );
    }
