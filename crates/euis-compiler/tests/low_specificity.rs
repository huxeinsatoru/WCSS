// Feature: euis-framework, Property 18: Low Specificity CSS
...
proptest! {
    ...
    /// For any Euis source, the generated CSS SHALL use single-class selectors
    /// (low specificity) to ensure JavaScript inline styles and library-driven
    /// styles can override Euis styles.
    /// 
    /// Validates: Requirements 18.1, 18.4, 18.7
    #[test]
    ...
    /// For any Euis source, the generated CSS SHALL not contain !important
