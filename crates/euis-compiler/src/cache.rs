...
mod tests {
    ...
    fn test_cache_basic() {
        ...
        assert!(cache.has_changed("test.euis", source));

        cache.update_file_hash("test.euis", source);
        assert!(!cache.has_changed("test.euis", source));

        // Changed source
        assert!(cache.has_changed("test.euis", ".btn { color: blue; }"));
    }
    ...
    fn test_cache_stats() {
        ...
        cache.update_file_hash("a.euis", "body {}");
        cache.update_file_hash("b.euis", "div {}");
    ...
    fn test_cache_clear() {
        ...
        cache.update_file_hash("a.euis", "body {}");
        cache.clear();
        assert!(cache.has_changed("a.euis", "body {}"));
    }
}
