...
pub fn generate(stylesheet: &StyleSheet, original_source: &str) -> String {
    ...
    format!(
        r#"{{"version":3,"file":"output.css","sourceRoot":"","sources":["input.euis"],"sourcesContent":[{source_content}],"names":[],"mappings":"{encoded_mappings}"}}"#,
...
mod tests {
    ...
    fn test_generate_sourcemap() {
        ...
        assert!(sourcemap.contains("\"sources\":[\"input.euis\"]"));
    }
}
